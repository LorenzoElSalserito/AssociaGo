...
public class FiscalController {
    ...
    @GetMapping("/invoice-checks")
    public List<InvoiceCheck> getInvoiceCheckHistory(@RequestParam Long associationId) {
        return fiscalService.getInvoiceCheckHistory(associationId);
    }
}
